...
class RequirementFileNotFound(Exception):
    ...
    def __repr__(self):
        return f'Requirement file not found in {self.path}, your artifact should contain "Pipfile" or "requirement.txt"'
...
class PKGInstallError(Exception):
    def __init__(self, detail: Optional[str] = None, exit_code: Optional[int] = None):
        ...
        super(PKGInstallError, self).__init__()

    def __repr__(self):
        return f'Install pkg failure, exit code: {self.exit_code}. \nDetail: {self.detail}'
