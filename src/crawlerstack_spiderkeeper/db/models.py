...
class Artifact(BaseModel):
    ...
    project_id = Column(Integer, ForeignKey("project.id", ondelete='CASCADE'), nullable=False)  # 级联删除
...
class Job(BaseModel):
    ...
    reports = relationship('Storage', backref='job', cascade='all, delete-orphan', passive_deletes=True, uselist=False)
