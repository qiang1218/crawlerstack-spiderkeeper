...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("state", sa.Integer(), nullable=True, comment="存储任务状态"),
        sa.Column(
            "detail",
            sa.String(length=1000),
            nullable=True,
            comment="存储任务详情，失败后的值可以存在这里，便于诊断",
        ),
    ...
    op.create_table(
        ...
        sa.Column("create_time", sa.DateTime(), nullable=True, comment="创建时间"),
        sa.Column("update_time", sa.DateTime(), nullable=True, comment="更新时间"),
        sa.Column("state", sa.Integer(), nullable=True, comment="任务状态"),
        sa.Column("item_count", sa.Integer(), nullable=True, comment="写入数据数量"),
        sa.Column("detail", sa.Text(), nullable=True, comment="任务详情"),
        sa.Column(
            "container_id", sa.String(length=120), nullable=True, comment="容器 ID"
        ),
        sa.Column("job_id", sa.Integer(), nullable=True),
